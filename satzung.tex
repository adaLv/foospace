...
% [1]
%----todo:
%    geschäftsordnung: Vorstand möchte alle Mitgliedsbewerber kennen? Oder Frist etc?
...
% Gäste mit zur MV (aka Mitgliederplenum), ohne Stimmrecht
% Anwesenheit zur MV (VoIP) in der GO definieren
% GO: Menge an Menschen erhöhen, welche eine Mitgliederversammlung autorisieren müssen, um die Satzung zu ändern (50) oder Verein aufzulösen §10, Vorstand absetzen